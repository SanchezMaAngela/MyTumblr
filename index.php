<?php
	...
	$acc_username = "AngelaSanchez";
	$acc_password = "gela143";
	$acc_fullname = "Ma. Angela Sanchez";
	...
	//SESSION VARIABLES
		...
		$_SESSION['ses_pass'] = $acc_password;
		$_SESSION['ses_name'] = $acc_fullname;
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
		      		...
		      		<div class="form-group">
		      			...
		      			if(isset($_REQUEST['notexist']) === true){
		      				...
		      				echo "<div class= 'alert alert-warning' role= 'alert'> You are still logged in. <a href= 'account.php'> Click here to proceed.</a> </div>";
		      			}
